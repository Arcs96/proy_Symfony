...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0' => 'get193529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0Service',
            '2_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0' => 'get293529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0Service',
        ...
        $this->privates = array(
            '1_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0' => true,
            '2_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0']) ? $this->services['1_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0'] : $this->get193529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0']) ? $this->services['2_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0'] : $this->get293529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'proy_rural', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array('charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci')), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\RuralBundle\\Entity'))), 'RuralBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('RuralBundle' => 'RuralBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_7a55ef370c94a9c9040aa770bfe89743bd188881441572bce473b7c74f30cc9a');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\RuralBundle/Resources/views'), 'Rural');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d03a801f5f7d9febc151506d93d1012aa64f819e');
    }
    ...
    /**
     * Gets the private '1_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get193529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0Service()
    {
        return $this->services['1_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get293529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0Service()
    {
        return $this->services['2_93529ad409a25f94b8cf74084ab8e6d7daad2270e982a0366a93e7c75e351ad0'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('U+KmxwFIIl', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2tjupE7Zc0', 0, '-P3Po+Bn8I+u6-tLI+HOhH', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y6erx+VGMt', 0, '-P3Po+Bn8I+u6-tLI+HOhH', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BKcVnXSyE9', 0, '-P3Po+Bn8I+u6-tLI+HOhH', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59ee173213b685.04308944');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'RuralBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\RuralBundle'),
                    'namespace' => 'RuralBundle',
                ),
                'PrincipalBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PrincipalBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'RuralBundle' => 'RuralBundle\\RuralBundle',
            ...
            'secret' => 'd03a801f5f7d9febc151506d93d1012aa64f819e',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'd03a801f5f7d9febc151506d93d1012aa64f819e',
